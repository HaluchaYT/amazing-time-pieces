              ...
              <section className="bg-bone-50 border border-ink-100 p-6 sm:p-8">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { k: 'in-person', t: 'In-Person Delivery', d: 'A specialist delivers by hand — by arrangement', p: 'By arrangement' },
                    { k: 'appointment', t: 'In-Person Pickup', d: 'Collect in person by appointment', p: 'Complimentary' },
                  ].map((opt) => (
                    <label
                      key={opt.k}
