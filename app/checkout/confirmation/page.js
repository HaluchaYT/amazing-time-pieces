    ...
    <>
      ...
      <section className="py-10 sm:py-16">
        <div className="container-x max-w-4xl">
          {/* HERO CONFIRMATION */}
          <div className="bg-gradient-to-br from-ink-900 to-ink-950 border border-champagne-300/40 p-8 sm:p-12 text-center">
            <div className="w-16 h-16 mx-auto rounded-full bg-champagne-300/15 border border-champagne-300/40 flex items-center justify-center">
            ...
            <div className="mt-8 inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-6 text-sm border-t border-b border-white/10 py-4 px-6">
              <div>
                ...
                <div className="font-serif text-lg text-champagne-200 mt-0.5">{orderId}</div>
              </div>
              ...
              <div>
                ...
                <div className="font-serif text-lg text-champagne-200 mt-0.5">{formatPrice(payment.subtotal)}</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 bg-ink-900 border border-white/10 p-6 sm:p-10">
            ...
            <div className="space-y-6">
              {meta.instructions.map((step, i) => (
                <div key={i} className="flex gap-5">
                  <div className="w-9 h-9 rounded-full border border-champagne-300/50 text-champagne-200 flex items-center justify-center flex-shrink-0 font-serif">
                    {i + 1}
                  </div>
                  <div>
            ...
            <div className="mt-10 p-5 bg-black/50 border border-white/10 text-sm text-white/70 leading-relaxed">
              <div className="text-[10px] uppercase tracking-widest text-champagne-200 mb-2">A note on this demo</div>
          ...
          <div className="mt-8 bg-ink-900 border border-white/10 p-6 sm:p-8">
            ...
            <div className="mt-6 divide-y divide-white/10">
              {payment.items.map((i) => (
                <div key={i.id} className="py-5 flex items-center gap-4">
                  ...
                  <div className="font-serif text-lg text-champagne-200 whitespace-nowrap">
                    {formatPrice(i.price)}
                  </div>
                </div>
              ))}
            ...
            <div className="mt-6 pt-6 border-t border-white/10 flex items-baseline justify-between">
              ...
              <span className="font-serif text-3xl text-champagne-200">{formatPrice(payment.subtotal)}</span>
            </div>
          </div>
          ...
          <div className="mt-16 text-center text-xs text-white/40">
            ...
            <a href="mailto:concierge@amazingtimepieces.com" className="text-champagne-200 hover:underline">
