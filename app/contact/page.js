          ...
          <aside className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-gradient-to-br from-bone-50 to-bone-100 border border-oxblood-600/30 p-7">
              ...
              <div className="mt-6 flex items-center gap-4">
                <a href="https://instagram.com/roamtimepieces" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 border border-ink-200 flex items-center justify-center text-ink-600 hover:border-oxblood-600 hover:text-oxblood-600 transition-all">
