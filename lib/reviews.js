...
//   - Store name: Amazing Timepieces LLC (renamed from "Time Promoter",
//     original URL slug preserved so the link keeps working)
...
//   `platforms.ebay.reviews`, sign into eBay and copy each row from the
//   store page's Feedback tab into the array shape shown below.
//
// Google / Yelp: No public Business Profile or Yelp listing was
//   located for Amazing Time Pieces at the time of build.
...
export const platforms = {
  ebay: {
    name: 'eBay',
    handle: 'Amazing Timepieces LLC',
    url: 'https://www.ebay.com/str/timepromoter',
    feedbackUrl: 'https://www.ebay.com/str/timepromoter',
    rating: 5.0,
    positive: 100,
    totalSold: 267,
    followers: 16,
