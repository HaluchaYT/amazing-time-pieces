    ...
    <footer className="relative bg-ink-800 text-bone-100 pt-20 pb-8 overflow-hidden border-t-2 border-oxblood-600">
      ...
      <div className="relative container-x">
        <div className="text-center max-w-3xl mx-auto mb-16 pb-16 border-b border-bone-100/10">
          <svg width="34" height="34" viewBox="0 0 32 32" className="text-oxblood-400 mx-auto opacity-90">
          ...
          <p className="font-serif italic text-2xl sm:text-3xl mt-6 text-bone-100 text-balance">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-14">
          <div className="col-span-2 md:col-span-1">
            <div className="font-serif text-xl text-bone-50">Amazing Timepieces</div>
            <div className="text-[10px] uppercase tracking-[0.4em] text-oxblood-300 mt-2">
              Est. MMXIV — New York
            </div>
            ...
            <div className="mt-6 flex gap-4">
              <a href="https://instagram.com" aria-label="Instagram" className="w-9 h-9 border border-bone-100/25 flex items-center justify-center text-bone-100/70 hover:border-oxblood-400 hover:text-oxblood-300 transition-all">
              ...
              <a href="https://facebook.com" aria-label="Facebook" className="w-9 h-9 border border-bone-100/25 flex items-center justify-center text-bone-100/70 hover:border-oxblood-400 hover:text-oxblood-300 transition-all">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
